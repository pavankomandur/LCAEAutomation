...
@Ignore
public class LcaeAutomationStepDefinitions extends LcaeAutomationApplicationTests {

    private final Logger log = LoggerFactory.getLogger(LcaeAutomationStepDefinitions.class);
